...
MESSAGES: dict[str, str] = {
    ...
    "tui.filters_title": "── Filters ──────────────",
    "tui.label_name": "Name (fuzzy)",
    "tui.label_sort": "Sort",
    "tui.label_top": "Top N",
    "tui.label_genres": "Genres (comma-sep)",
    "tui.label_exclude": "Exclude genres",
    "tui.label_progress": "Progress",
    "tui.label_category": "Category",
    "tui.label_min_hours": "Min hours",
    "tui.label_max_hours": "Max hours",
    "tui.label_collection": "Collection",
    "tui.label_era": "Release era",
    "tui.saved": "Saved to output/howl.csv and .md",
    "tui.status_bar": " Showing {shown} of {total} filtered · sort: {sort}",
}
